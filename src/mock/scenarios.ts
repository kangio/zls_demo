...
export const scenarios: Record<ScenarioKey, Scenario> = {
  rag: {
    key: 'rag', name: 'RAG Agent', short: '知识检索、多轮问答与共享前缀', model: 'Qwen3-235B-A22B', modelSize: '235B / 22B Active', framework: 'vLLM 0.9', runtime: 'CUDA 12.8', comm: 'NCCL 2.27', gpu: 'A5 64GB', gpuCount: 768, nodes: 96,
  ...
  coding: {
    key: 'coding', name: 'Coding Agent', short: '代码理解、工具执行与分支修复', model: 'DeepSeek-Coder-V2', modelSize: '236B / 21B Active', framework: 'vLLM 0.9', runtime: 'CUDA 12.8', comm: 'NCCL 2.27', gpu: 'A5 64GB', gpuCount: 896, nodes: 112,
