...
function DetailedSimulationTopology({progress}:{progress:number}){
  ...
  return <div className="sim-network detailed"><label>03 · HOMOGENEOUS LEAF–SPINE FABRIC · SERVER RESOURCE PLACEMENT</label><svg viewBox="0 0 820 565" preserveAspectRatio="xMidYMid meet" role="img" aria-label="同构 Leaf Spine 网络以及服务器内部模型实例 NPU HBM HCCS DDR NIC SSD 连接关系">
